...
~/.claude/skills/devola-flow/references/         (8 files)
...
[ "$(ls ~/.cursor/skills/devola-flow/references 2>/dev/null | wc -l)" = "8" ] \
                                                   && echo "[PASS] Cursor 8 references"  || echo "[FAIL] Cursor references"
...
[ "$(ls ~/.claude/skills/devola-flow/references 2>/dev/null | wc -l)" = "8" ] \
                                                  && echo "[PASS] Claude 8 references" || echo "[FAIL] Claude references"
