...
(function () {
  ...
  var EN = {
    ...
    'exp.link.seedsDesc': '23 declarative checklist seeds',
    ...
    'exp.card.seedCount': '{count} / 23 seeds',
    ...
    'exp.seed.note': 'Current source_stages references across the 23 shipped seeds.',
  ...
  var ZH = {
    ...
    'exp.link.seedsDesc': '23 个声明式清单种子',
    'exp.link.system': '系统',
  ...
  function buildSeedMembership(catalog) {
    if (!catalog ||
        ...
        catalog.record_count !== 23 ||
        !Array.isArray(catalog.seeds) ||
        catalog.seeds.length !== 23) {
      return null;
    }
