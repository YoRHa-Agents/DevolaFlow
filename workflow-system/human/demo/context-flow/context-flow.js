...
(function () {
  ...
  var EN_REQUIRED = {
    ...
    'cf.section.escalation.desc':             'Always upward, never skip levels — Task → Wave → Project → Human.',
    ...
    'cf.escalation.severity.humanIntervene':  'HUMAN_INTERVENE — stop the affected wave/round, present options to human',
  ...
  var ZH_REQUIRED = {
    ...
    'cf.escalation.severity.humanIntervene':  'HUMAN_INTERVENE — 暂停受影响的波次/轮次、向人类呈现选项',
