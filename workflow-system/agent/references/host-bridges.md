...
purpose: >
  ...
  Cursor, Claude Code, Codex, KimiCode, and DSH into DevolaFlow's
...
`DEVOLAFLOW_HOST_ENFORCE` (`references/env-flags.md` §2.18), and the audit
...
| `host` | str | `cursor` / `claude` / `codex` / `kimi` / `dsh` |
