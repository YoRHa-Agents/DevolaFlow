...
> **Now Using DevolaFlow v8.1.0-rc.1**

# DevolaFlow

## Version & Update
**Current version:** 8.1.0-rc.1 — Check: `curl -fsSL https://raw.githubusercontent.com/YoRHa-Agents/DevolaFlow/main/src/devolaflow/__init__.py | grep '__version__'`
