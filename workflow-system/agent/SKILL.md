...
Every active change/task first-batch write MUST include `entrance.md` with
`goal.md`, `checklist.md`, `stage.md`, `preflight.md`, `spec.md`, `STATUS.yaml`,
`owned_files.txt`, and `evidence/`; `learnings.jsonl` remains opt-in.
