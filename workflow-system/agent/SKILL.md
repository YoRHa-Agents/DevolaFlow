...
> **Now Using DevolaFlow v5.0.0-pre**

# DevolaFlow

## Version & Update

**Current version:** 5.0.0-pre — Check: `curl -fsSL https://raw.githubusercontent.com/YoRHa-Agents/DevolaFlow/main/src/devolaflow/__init__.py | grep '__version__'`
