...
[![Version](https://img.shields.io/badge/version-5.1.0-pre-green.svg)](https://github.com/YoRHa-Agents/DevolaFlow/releases)
...
```bash
devola-version                   # prints "DevolaFlow v5.1.0-pre"
