...
[![Version](https://img.shields.io/badge/version-8.1.0-rc.1-green.svg)](https://github.com/YoRHa-Agents/DevolaFlow/releases)
...
DevolaFlow includes a built-in benchmark suite (42 scenarios covering all 22 context profiles) that measures how effectively context is routed to agents:

```bash
python -m benchmarks.devolaflow_context.runner --scenario all              # run all 42 scenarios
...
```bash
devola-version                   # prints "DevolaFlow v8.1.0-rc.1"
