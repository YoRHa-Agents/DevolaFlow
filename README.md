...
[![Version](https://img.shields.io/badge/version-7.2.2-green.svg)](https://github.com/YoRHa-Agents/DevolaFlow/releases)
...
DevolaFlow includes a built-in benchmark suite (35 scenarios covering all 22 context profiles) that measures how effectively context is routed to agents:

```bash
python -m benchmarks.devolaflow_context.runner --scenario all              # run all 35 scenarios
...
```bash
devola-version                   # prints "DevolaFlow v7.2.2"
