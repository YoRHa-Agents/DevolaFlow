...
[![Version](https://img.shields.io/badge/version-7.1.0-green.svg)](https://github.com/YoRHa-Agents/DevolaFlow/releases)
...
DevolaFlow includes a built-in benchmark suite (33 scenarios covering all 22 context profiles) that measures how effectively context is routed to agents:

```bash
python -m benchmarks.devolaflow_context.runner --scenario all              # run all 33 scenarios
...
```bash
devola-version                   # prints "DevolaFlow v7.1.0"
