...
[![Version](https://img.shields.io/badge/version-5.0.0-pre-green.svg)](https://github.com/YoRHa-Agents/DevolaFlow/releases)
...
```bash
devola-version                   # prints "DevolaFlow v5.0.0-pre"
