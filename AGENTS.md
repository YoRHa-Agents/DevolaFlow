...
| Large | ≤ 1000 | `workflow-system/agent/references/*.md` (9 files) |
...
Every `references/xxx.md` path mentioned in SKILL.md must correspond to an actual file under `workflow-system/agent/references/`. Valid references: `agent-hierarchy.md`, `behavioral-guidelines.md`, `context-isolation.md`, `decomposition-gate.md`, `execution-protocol.md`, `message-schemas.md`, `meta-framework.md`, `repo-modes.md`, `team-roles.md`.
