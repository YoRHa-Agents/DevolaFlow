...
Changes to SKILL.md or CLAUDE.md trigger ALL of: (1) line count check ≤ 500, (2) `build-skill` for all 4 adapters, (3) `make test-harness` passes, (4) version consistency passes. Partial compliance is treated as full violation.
