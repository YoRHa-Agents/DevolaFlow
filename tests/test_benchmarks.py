...
V6_BASELINE_PATH = BASELINES_DIR / "v7.7.0_baseline.json"
...
class TestBaselineFile:
    ...
    def test_runner_prefers_latest_baseline(self) -> None:
        ...
        assert newest.name == "v7.7.0_baseline.json", (
            f"Expected load_baseline() to prefer v7.7.0_baseline.json; got {newest.name}"
        )
