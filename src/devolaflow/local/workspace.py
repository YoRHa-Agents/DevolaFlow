...
- `checklist.md` — evidence-backed AC + implementation checklist (<= 1200 tokens)
- `stage.md` — round-control ledger (<= 400 tokens)
- `preflight.md` — pre-decision authorization record (<= 600 tokens)
